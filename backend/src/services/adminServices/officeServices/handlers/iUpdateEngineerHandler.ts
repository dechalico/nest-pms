...
export abstract class IUpdateEngineerHandler
  implements IAsyncInteractorHandler<UpdateEngineerArgs, AppResult<UpdateEngineerResult>>
{
  executeAsync(args: UpdateEngineerArgs): Promise<AppResult<UpdateEngineerResult>> {

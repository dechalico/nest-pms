...
import { GetOfficesArgs, GetOfficesResult } from '../interactors/getOfficesInteractor';

export abstract class IGetOfficesHandler
  implements IAsyncInteractorHandler<GetOfficesArgs, AppResult<GetOfficesResult>>
{

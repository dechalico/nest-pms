...
export abstract class IDefaultAdminHandler
  implements IAsyncInteractorHandler<DefaultAdminArgs, AppResult<DefaultAdminResult>>
{
  abstract executeAsync(args: DefaultAdminArgs): Promise<AppResult<DefaultAdminResult>>;
}
